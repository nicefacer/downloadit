...
class VerticalMenuObject extends ObjectModel
{
    public $name;
    public $tab_link;
    public $tab_position;
    ...
    {
        $this->position = VerticalMenuObject::getPosition();
    ...
    private static function getPosition()
    {
        return (Db::getInstance()->getValue('
            ...
            FROM `'._DB_PREFIX_.'vertical_menu_tabs`'
        ));
    }
    ...
    public function reorder()
    {
        ...
        for ($i = 0; $i < $sizeof; ++$i)
            Db::getInstance()->execute('
                UPDATE `'._DB_PREFIX_.'vertical_menu_tabs`
                SET `position` = '.($i + 1).'
