...
function upgradePsConfiguration_7_2_0()
{
    ...
    //     && Configuration::updateValue('AV_DISPLAYSNIPPETPRODUIT', '0')
    //         && Configuration::updateValue('AV_DISPLAYSNIPPETPRODUITLI', '0')
    //             && Configuration::updateValue('AV_DISPLAYSNIPPETSITE', '0')
