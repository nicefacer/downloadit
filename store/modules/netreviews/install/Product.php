...
class Product extends ProductCore
{
    public static function getProductProperties($id_lang, $row, Context $context = null)
    {
        ...
        $product_av['av_stats'] = $NetReviewsModel->getStatsProduct($product_av['id_product'], $id_lang, $id_shop);
        if ($all_multishops_reviews || $all_languages_reviews){ // override rate & nb_reviews 
            $language_group = ($all_languages_reviews)?null:$id_lang;
            $shop_id_group = ($all_multishops_reviews)?null:$id_shop;
            $reviews = $NetReviewsModel->getProductReviews($product_av['id_product'], $language_group, $shop_id_group, 0, 1, 'horodate_DESC', 0, false);
            ...
            if ($num_reviews > 0){
                ...
                $product_av['av_stats']['rate'] = $somme_rate / $num_reviews;
                $product_av['av_stats']['nb_reviews'] = $num_reviews;
            }
        }
        $product_av['av_rate'] = "";
