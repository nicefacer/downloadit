      ...
      <div class="netreviews_rating_header">
         ...
         <div class="av-certificate">
            ...
            <span id="netreviews_informations">
               ...
               <ul>
                  <li> {l s='For further information on the nature of the review controls, as well as the possibility of contacting the author of the review please consult our' mod='netreviews'} <a href="{$url_cgv|escape:'htmlall':'UTF-8'}" target="_blank" rel="nofollow noreferrer noopener">CGU</a>.</li>
            ...
            <ul class="netreviews_rates_list">
               ...
               <li class="netreviews_rate_list_item {if $review_portion > 0}cursorp{/if}" {if $review_portion > 0} onclick="javascript:netreviewsFilter({$reviews_rate_portion_key|escape:'htmlall':'UTF-8'});" {/if} >
                  ...
                  <div class="netreviews_rate_graph">
                     <span class="netreviews_rate_percent" style="{if (!$use_image)}background:#{$customized_star_color|escape:'htmlall':'UTF-8'};{/if}height:{if $review_portion > 0}{math equation='a/b*100' a=$review_portion b=$count_reviews}{else}1{/if}%">
