...
<div class="bootstrap">
	...
	<div class="form_combinations" style="display: none;">
		<div style="text-align: right; margin-bottom: 10px;">
			...
			<a class="button btn btn-default close_form_combinations" href="#">{l s='Close' mod='dgridproducts'}</a>
		</div>
		<div class="form_create_combination form_cc" style="display: none;">
			<form id="form_create_combination">
				...
				<div class="row">
					<label class="control-label col-lg-12">{l s='Attribute' mod='dgridproducts'}</label>
					<div class="col-lg-9">
				...
				{if is_array($attribute_groups) && count($attribute_groups)}
					{foreach from=$attribute_groups item=attribute_group}
						<div class="row" data-group="{$attribute_group.id_attribute_group|intval}">
							<label class="control-label col-lg-12">{l s='Value' mod='dgridproducts'}</label>
							<div class="col-lg-6">
				...
				<div class="row">
					<label class="control-label col-lg-12">{l s='Reference' mod='dgridproducts'}</label>
					<div class="col-lg-8">
						<input type="text" id="attribute_reference" name="attribute_reference" value="">
					</div>
				</div>
				<div class="row">
					<label class="control-label col-lg-12">{l s='EAN-13 or JAN barcode' mod='dgridproducts'}</label>
					<div class="col-lg-8">
						<input maxlength="13" type="text" id="attribute_ean13" name="attribute_ean13" value="">
					</div>
				</div>
				<div class="row">
					<label class="control-label col-lg-12">{l s='UPC barcode' mod='dgridproducts'}</label>
					<div class="col-lg-8">
						<input maxlength="12" type="text" id="attribute_upc" name="attribute_upc" value="">
					</div>
				</div>
				<div class="row">
					<label class="control-label col-lg-12">{l s='Wholesale price' mod='dgridproducts'}</label>
					<div class="col-lg-8">
				...
				<div class="row">
					<label class="control-label col-lg-12">{l s='Impact on price' mod='dgridproducts'}</label>
					<div class="col-lg-8">
				...
				<div class="row">
					<label class="control-label col-lg-12">{l s='Final price' mod='dgridproducts'}:</label>
					<div class="col-lg-8">
						<div class="pa_final_price">{displayPrice price=0}</div>
					</div>
				</div>
				<div class="row">
					<label class="control-label col-lg-12">{l s='Impact on weight' mod='dgridproducts'}</label>
					<div class="col-lg-8">
				...
				<div class="row">
					<label class="control-label col-lg-12">{l s='Impact on unit price' mod='dgridproducts'}</label>
					<div class="col-lg-8">
				...
				<div class="row">
					<label class="control-label col-lg-12">{l s='Minimal quantity' mod='dgridproducts'}</label>
					<div class="col-lg-8">
						<input maxlength="6" name="attribute_minimal_quantity" id="attribute_minimal_quantity" type="text" value="1">
					</div>
				</div>
				<div class="row">
					<label class="control-label col-lg-12">{l s='Available(date)' mod='dgridproducts'}</label>
					<div class="col-lg-8">
						<input class="datepicker" id="available_date_attribute" name="available_date_attribute" value="0000-00-00" type="text">
					</div>
				</div>
				<label class="control-label col-lg-12">{l s='Images' mod='dgridproducts'}</label>
	...
	<div class="form_images" style="display: none;">
		<div style="text-align: right; margin-bottom: 10px;">
			<a class="button btn btn-success add_image" href="#">
				<input class="add_image_input" name="add_image_input" type="file"/>
				<i class="icon-plus"></i>
	...
	<div class="form_features" style="display: none;">
		<div style="text-align: right; margin-bottom: 10px;">
			<a class="button btn btn-default close_form_features" href="#">{l s='Close' mod='dgridproducts'}</a>
		</div>
		<div class="content_form">
	...
	<div class="form_seo" style="display: none;">
		<div style="text-align: right; margin-bottom: 10px;">
			<a class="button btn btn-default close_form_seo" href="#">{l s='Close' mod='dgridproducts'}</a>
		</div>
		<div class="content_form"></div>
	</div>
