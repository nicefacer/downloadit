...
<div id="product-seo" class="panel product-tab {if $ps_version < 1.6}v15{/if}">
	...
	{include file="`$back_tpl_dir`controllers/products/multishop/check_fields.tpl" product_tab="Seo"}
	<div class="form-group">
		...
		<div class="col-lg-8">
			{include file="`$back_tpl_dir`controllers/products/input_text_lang.tpl"
				languages=$languages
	...
	<div class="form-group hide">
		...
		<div class="col-lg-8">
			{include file="`$back_tpl_dir`controllers/products/input_text_lang.tpl" languages=$languages
	...
	<div class="panel-footer">
		<a href="#" class="btn btn-default close_form_seo"><i class="process-icon-cancel"></i> {l s='Cancel' mod='dgridproducts'}</a>
