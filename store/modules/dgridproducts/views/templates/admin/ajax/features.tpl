...
<div id="product-features" class="panel product-tab">
	...
	<div class="panel-footer">
		<a href="{$link->getAdminLink('AdminProducts')|escape:'html':'UTF-8'}" class="btn btn-default close_form_features"><i class="process-icon-cancel"></i> {l s='Cancel' mod='dgridproducts'}</a>
