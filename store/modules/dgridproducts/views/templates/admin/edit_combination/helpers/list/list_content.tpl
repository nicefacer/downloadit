...
{block name="td_content"}
    ...
    {else}
        ...
        {/if}
        <div
                class="{if isset($params.image_c)}edit_image {/if}{if isset($params.need_edit) && $params.need_edit} edit_field {if $params.validate == 'category'}edit_category{/if} {if $ps_v < 1.6}v15{/if}
                {/if}"
