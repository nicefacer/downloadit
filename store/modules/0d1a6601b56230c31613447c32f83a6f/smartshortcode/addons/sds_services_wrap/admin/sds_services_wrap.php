...
<form action="" id="smartshortcode_service_form" class="smartshortcode_form">
    <div class="form-group"><label>Services Columns</label></div>
...
$(function(){
    ...
    $(document.body).on('submit','#smartshortcode_service_form',function(){
        ...
        scodeb += '[sds_services_wrap]';
        scodea += '[/sds_services_wrap]';
