...
class Installer
{
    ...
    {
        $this->_resourceFilePath = _PS_MODULE_DIR_ . "prestabay/var/sql";
    }
    ...
    public function registerHook($hookName)
    {
        ...
        try {
            if (!Module::getInstanceByName("prestabay")->registerHook($hookName)) {
    ...
    {
        if (!Module::getInstanceByName("prestabay")->unregisterHook($hookName)) {
