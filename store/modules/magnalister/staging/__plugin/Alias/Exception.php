...
class MLException {
     ...
     * @param string $sExeption name of exception
     * @return Exception
     */
    public static function factory($sExeption, $sMessage = '', $iCode = 0, $oPrevious = null) {
        $sCurrentClassName=  MLFilesystem::gi()->loadClass('exception_'.$sExeption);
