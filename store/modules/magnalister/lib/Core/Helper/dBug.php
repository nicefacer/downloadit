...
class dBug {
	...
	var $arrHistory = array();
                   var $blShowTitel = true;
	
	//constructor
	function dBug($var,$forceType="",$bCollapsed=false,$blShowTitel=true) {
		...
		$this->bCollapsed = $this->blShowTitel?$bCollapsed:true;
                                      $this->blShowTitel = $blShowTitel;
