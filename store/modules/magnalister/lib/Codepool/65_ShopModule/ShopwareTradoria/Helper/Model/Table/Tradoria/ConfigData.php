 ...
 * -----------------------------------------------------------------------------
 */
MLFilesystem::gi()->loadClass('Tradoria_Helper_Model_Table_Tradoria_ConfigData');

class ML_ShopwareTradoria_Helper_Model_Table_Tradoria_ConfigData extends ML_Tradoria_Helper_Model_Table_Tradoria_ConfigData {
    
    public function orderimport_paymentmethodField (&$aField) {
        MLMessage::gi()->addDebug('here is class'.get_class($this));
