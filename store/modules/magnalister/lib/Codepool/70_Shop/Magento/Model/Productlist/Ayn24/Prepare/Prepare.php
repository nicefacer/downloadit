...
class ML_Magento_Model_ProductList_Ayn24_Prepare_Prepare extends ML_Magento_Model_ProductList_Abstract {
    ...
    protected function initList() {
        $this->oList = MLHelper::gi('model_productlist_ayn24_list');
    }
