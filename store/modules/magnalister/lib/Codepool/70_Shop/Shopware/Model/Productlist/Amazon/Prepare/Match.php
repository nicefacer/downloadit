...
class ML_Shopware_Model_ProductList_Amazon_Prepare_Match extends ML_Shopware_Model_ProductList_Abstract {
    ...
    protected function executeList(){
        $this->oList
            ->image()
            ->product()
//            $this->oList->manufacturer($sValue,true,MLI18n::gi()->get('Productlist_Header_Field_sManufacturerpartnumber'));
            ->priceShop()
            ->priceMarketplace()
            ->preparedStatus()
        ;
