...
class ML_ZzzzDummy_Model_ProductListDependency_SearchFilter extends ML_Shop_Model_ProductListDependency_SearchFilter_Abstract {
    ...
    public function manipulateQuery($mQuery) {
        ...
        if (!empty($sFilterValue)) {
            $mQuery->where("`name` like '%". $sFilterValue."%' OR `sku` like '%".$sFilterValue."%'");
        }
    }
