...
class ML_Prestashop_Model_ProductListDependency_ProductStatusFilter extends ML_Shop_Model_ProductListDependency_ProductStatusFilter_Abstract {
    ...
    protected function getFilterValues() {
        return array (
            '' => array (
                'value' => '' ,
                'label' => sprintf(MLI18n::gi()->get('Productlist_Filter_sEmpty') , MLI18n::gi()->get('Prestashop_Productlist_Filter_sStatus'))
            ),
            'active' => array (
                'value' => 'active' ,
                'label' => MLI18n::gi()->get('Prestashop_Productlist_Filter_sActive') ,
            ),
            'inactive' => array (
                'value' => 'inactive' ,
                'label' => MLI18n::gi()->get('Prestashop_Productlist_Filter_sInactive') ,
            )
        );
    }
