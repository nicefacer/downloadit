 ...
 */
class ML_Amazon_Model_ProductList_Amazon_Checkin_Summary extends ML_Productlist_Model_ProductList_Selection{
    ...
    public function getList() {
        if($this->aList===null){
            ...
            foreach(MLDatabase::getDbInstance()->fetchArray(sprintf($sSql,' distinct p.ParentId ')." limit ".$this->iFrom.", ".$this->iCount) as $aRow){
                ...
                if($oProduct->exists()){
                    $this->aList[$aRow['ParentId']]=$oProduct;
                }
            }
        }
