<?php 
    ...
    $oProgress = 
        ...
        ->setContent(MLI18n::gi()->get('sModal_'.(ML::gi()->isUpdate() ? 'update' : 'install' ).'Plugin_content'))
    ...
    ?>
        ...
        <?php } else { ?>
            <?php 
                ...
                $oProgress->render();
            ?>
            <div id="ml-js-pushMessages" style="padding-top: 1em;"><?php 
                ...
                ;
            ?></div>
            <a class="global-ajax ml-global-ajax-triggerAfterSuccessCurrentUrl" data-ml-global-ajax='{"triggerAfterSuccess":"currentUrl", "retryOnError": true}' style="display:none;" id="updateMLPlugin" href="<?php echo MLHttp::gi()->getUrl(array('do' => 'update', 'method' => 'update')); ?>"></a>
