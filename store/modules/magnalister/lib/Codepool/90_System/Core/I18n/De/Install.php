...
MLI18n::gi()->sModal_updatePlugin_content = 'Es werden Dateien vom magnalister Server runtergeladen.';

MLI18n::gi()->sModal_installPlugin_title = 'magnalister-Plugin wird installiert.';
MLI18n::gi()->sModal_installPlugin_content = 'Die magnalister Erstinstallation wird abgeschlossen.';
...
MLI18n::gi()->ML_ERROR_CANNOT_CONNECT_TO_SERVICE_LAYER_TEXT = '
    ...
    Anfrage schlug fehl. Sollte der Fehler weiterhin bestehen wenden Sie sich bitte an den Support von {#setting:MAGNA_SUPPORT_URL#}.
';
...
MLI18n::gi()->sUpdateError_doAgain = '
    ...
    Falls das Problem bestehen bleibt, kontaktieren Sie bitte den <a href="http://www.magnalister.com/kontakt" class="ml-js-noBlockUi" target="_blank">magnalister-Service</a>.
';
...
MLI18n::gi()->{'installation_content_freetest_url'} = 'http://www.magnalister.com/freetest/';
