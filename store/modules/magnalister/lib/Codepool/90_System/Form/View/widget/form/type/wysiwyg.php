...
?><div class="ml-js-noBlockUi"><textarea class="fullwidth tinymce<?php echo ((isset($aField['required']) && empty($aField['value'])) ? ' ml-error' : ''); ?>" rows="40" id="<?php echo $aField['id']; ?>" name="<?php echo MLHttp::gi()->parseFormFieldName($aField['name']) ?>"><?php echo isset($aField['value']) ? $aField['value'] : '' ?></textarea></div>
