...
MLI18n::gi()->ML_LABEL_MARKETPLACE_SHIPPING_TIME = 'Versandzeit';
...
MLI18n::gi()->ML_BUTTON_LABEL_REVERT = 'Vorbereitung aufheben';
...
MLI18n::gi()->ML_TEXT_BUTTON_CHECKIN_ADD = 'Wenn Sie auf <span class="button">{#i18n:ML_BUTTON_LABEL_CHECKIN_ADD#}</span> klicken,
...
MLI18n::gi()->ML_TEXT_BUTTON_CHECKIN_PURGE = 'Wenn Sie auf <span class="button">{#i18n:ML_BUTTON_LABEL_CHECKIN_PURGE#}</span> klicken,
            wird die alte CSV gel&ouml;scht und nur die &uuml;bermittelten Artikel sind enthalten';
MLI18n::gi()->ML_TEXT_CONFIG_SAVED_SUCCESSFULLY = 'Die Konfiguration wurde erfolgreich gespeichert.';
...
MLI18n::gi()->ML_TEXT_TAB_IDENT = 'Legt die Bezeichnung des Tabs f&uuml;r diesen Marketplace fest, um ihn besser von den anderen Marketplace-Tabs unterscheiden zu k&ouml;nnen (optional).';
...
MLI18n::gi()->ML_NOTICE_PLACE_PASSPHRASE = 'Bitte hinterlegen Sie Ihre PassPhrase. Diese erhalten Sie nach der 
        <a href="{#setting:sPublicUrl#}freetest/%s" title="Jetzt kostenlos testen" class="ml-js-noBlockUi" target="_blank">Registrierung</a>
...
MLI18n::gi()->ML_ERROR_ACCESS_DENIED_TO_SERVICE_LAYER_TEXT = 'Sie sind nicht berechtigt den magnalister-Service-Layer zu verwenden. 
            Bitte wenden Sie sich an den Support von {#setting:MAGNA_SUPPORT_URL#}.';
...
MLI18n::gi()->ML_ERROR_SUBMIT_PRODUCTS = 'Bei der &Uuml;bermittlung der Produkte an den magnalister-Service-Layer ist ein Fehler aufgetreten. 
            ...
            Sie sich bitte an den Support von {#setting:MAGNA_SUPPORT_URL#}.';
MLI18n::gi()->ML_ERROR_MISSING_CURRENCY = 'Die W&auml;hrung des Marketplaces (%s) den Sie in der Konfiguration ausgew&auml;hlt haben, unterscheidet sich von der 
...
MLI18n::gi()->ML_ERROR_FTP_CANNOT_CONNECT = 'Es kann &uuml;ber die von Ihnen angegeben Zugangsdaten keine Verbindung zu Ihrem Server hergestellt werden. 
            Bitte &uuml;berpr&uuml;fen Sie die FTP-Zugangsdaten. Sollte der Fehler weiterhin bestehen, wenden Sie sich bitte an den Support von {#setting:MAGNA_SUPPORT_URL#}.';
MLI18n::gi()->ML_ERROR_FTP_PATH_DOES_NOT_MATCH = 'Es konnte eine FTP-Verbindung hergestellt werden, jedoch konnte das Shop-Verzeichnis nicht ermittelt werden. 
            Bitte &uuml;berpr&uuml;fen Sie das Shop-Verzeichnis. Sollte der Fehler weiterhin bestehen, wenden Sie sich bitte an den Support von {#setting:MAGNA_SUPPORT_URL#}.';
MLI18n::gi()->ML_ERROR_FTP_PERMISSION_DENIED = 'Eine FTP-Verbindung konnte hergestellt werden. Jedoch hat der FTP-Benutzer keine Schreibrechte. 
        Bitte hinterlegen Sie einen Benutzer mit Schreibrechten. Sollte der Fehler weiterhin bestehen, wenden Sie sich bitte an den Support von {#setting:MAGNA_SUPPORT_URL#}.';
MLI18n::gi()->ML_ERROR_FTP_INCOMPLETE_DATA = 'Die FTP-Zugangsdaten sind unvollst&auml;ndig. Automatische Updates sind daher nicht m&ouml;glich. 
            F&uuml;r weitere Fragen wenden Sie sich bitte an den Support von {#setting:MAGNA_SUPPORT_URL#}.';
...
MLI18n::gi()->ML_ERROR_MARKETPLACE_TIMEOUT = 'Zurzeit ist die Schnittstelle dieses Marketplaces nicht erreichbar. Sollte diese Meldung nach l&auml;ngerer Wartezeit noch angezeigt werden,
...
MLI18n::gi()->ML_CONFIG_FIELD_EMPTY_OR_MISSING = 'Das Feld %s ist  ung&uuml;ltig oder leer. Bitte f&uuml;llen Sie das Feld aus.';
...
MLI18n::gi()->ML_GENERIC_ERROR_WRONG_CURRENCY = 'Die W&auml;hrung des Marketplaces (%s) unterscheidet sich von der Standardw&auml;hrung dieses Shops (%s). 
...
MLI18n::gi()->ML_AMAZON_LABEL_APPLY_BROWSENODE_NOT_SELECTED = 'Nicht vergeben';
...
MLI18n::gi()->ML_AMAZON_LABEL_ADDITIONAL_DATA = 'Weitere Daten';
...
MLI18n::gi()->ML_AMAZON_BUTTON_PREPARE = 'Beantragen vorbereiten';
...
MLI18n::gi()->ML_AMAZON_TEXT_REFRESH_REQUEST_SEND = 'Ihre Aktualisierungsanfrage wurde gesendet. Bitte beachten Sie, dass es bis zu einer Stunden dauern kann 
...
MLI18n::gi()->ML_AMAZON_TEXT_APPLY_REQUIERD_EAN = 'Nicht relevant, wenn an den Varianten EAN hinterlegt ist';

MLI18n::gi()->ML_AMAZON_ERROR_WRONG_CURRENCY = 'Die W&auml;hrung des Amazon-Marketplaces (%s) den Sie in der Konfiguration ausgew&auml;hlt haben unterscheidet sich von der 
...
MLI18n::gi()->ML_AMAZON_ERROR_CURRENCY_NOT_IN_SHOP = 'Die zu dem gew&auml;hlten Amazon-Marketplace geh&ouml;rende W&auml;hrung (%s) existiert in diesem Shop nicht.
...
MLI18n::gi()->ML_EBAY_CONDITION_VERY_GOOD = 'Gebraucht, wie neu';
...
MLI18n::gi()->ML_EBAY_SITE = 'eBay-Marketplace, auf dem Sie einstellen.';
...
MLI18n::gi()->ML_EBAY_SUBMIT_ADD_TEXT_ZERO_STOCK_ITEMS_REMOVED = 'Artikel mit Bestand = 0 wurden ausgelassen.';
...
/* Hitmeister */
MLI18n::gi()->ML_HITMEISTER_SAME_PRODUCT_THERE = 'Dieser Artikel bei Hitmeister.de';
MLI18n::gi()->ML_HITMEISTER_LABEL_HITMEISTER_PRICE = 'Mein Hitmeister Preis';
MLI18n::gi()->ML_HITMEISTER_LABEL_ORDER_ID = 'Hitmeister-Bestellnummer';
...
MLI18n::gi()->ML_RICARDO_PRODUCTS_NOT_SYNCRONIZED = 'Der Marktplatz verarbeitet nun ihre Daten und pr&uumlft auf inhaltliche Fehler. Bitte pr&uumlfen Sie nach ca. 30 Minuten den Reiter "Fehlerlog" auf eventuelles Feedback.';

MLI18n::gi()->ML_HITMEISTER_TEXT_NO_MATCHED_PRODUCTS = 'Es sind noch keine Produkte f&uuml;r Hitmeister vorbereitet worden. Bevor Sie Produkte hier hochladen k&ouml;nnen, m&uuml;ssen Sie diese unter dem Reiter "Produkte vorbereiten" bearbeiten.<br>
        Falls Sie an der Stelle Artikel vermissen sollten, die Sie bereits vorbereitet haben, &uuml;berpr&uuml;fen Sie, ob diese ggf. auf Inaktiv gesetzt sind und Sie die Konfiguration entsprechend eingestellt haben.';
MLI18n::gi()->ML_HITMEISTER_LABEL_LAST_REPORT = 'Letzter Bericht von Hitmeister';
