            ...
            <table class="ml-css-apirequests">
                ...
                <?php foreach ($tpR as $item) {?>
                    <tr class="ml-css-row ml-css-<?php echo strtolower($item['status']); ?>">
                        ...
                        <td class="ml-css-request"><textarea><?php echo htmlspecialchars(json_indent($item['request'])); ?></textarea></td>
                        <td class="ml-css-response"><textarea><?php echo htmlspecialchars(isset($item['response']) ? json_indent($item['response']) : '--'); ?></textarea></td>
                    </tr>
