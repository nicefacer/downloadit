...
MLI18n::gi()->check24_config_account_emailtemplate = 'Promotion-E-Mail Template';
MLI18n::gi()->check24_config_account_emailtemplate = 'Promotion-E-Mail Template';
...
MLI18n::gi()->add('check24_config_orderimport', array(
    ...
    'field' => array(
        ...
        'mwst.shipping' => array(
            ...
            'help' => '
                Check24 &uuml;bermittelt nicht den Steuersatz der Versandkosten, sondern nur die Brutto-Preise. Daher muss der Steuersatz zur korrekten Berechnung der Mehrwertsteuer f&uuml;r die Versandkosten hier angegeben werden. Falls Sie mehrwertsteuerbefreit sind, tragen Sie in das Feld 0 ein.
            ',
        ),
        //*/
        'importactive' => array(
