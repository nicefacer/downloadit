 ...
 * -----------------------------------------------------------------------------
 */
/** @var ML_MeinPaket_Controller_MeinPaket_Prepare_Variations $this */
    ...
    /*<![CDATA[*/
        jqml(document).ready(function() {
            jqml('#<?php echo $aDeleteButton['id'] ?>').click(function() {
                if (!confirm(unescape('<?php echo html_entity_decode(MLI18n::gi()->get('meinpaket_prepare_match_variations_delete'), ENT_COMPAT | ENT_HTML401, 'UTF-8') ?>'))) {
                    return false;
                }
            });
        });
