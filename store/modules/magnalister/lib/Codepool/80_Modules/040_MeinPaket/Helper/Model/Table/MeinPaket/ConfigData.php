...
class ML_MeinPaket_Helper_Model_Table_MeinPaket_ConfigData extends ML_Form_Helper_Model_Table_ConfigData_Abstract {
    ...
    public function primaryCategoryField(&$aField) {
        $aField['values'] = MLDatabase::factory('meinpaket_prepare')->getTopPrimaryCategories();
    }
