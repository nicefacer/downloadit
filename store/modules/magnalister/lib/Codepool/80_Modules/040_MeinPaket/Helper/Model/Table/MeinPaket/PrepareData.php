...
class ML_MeinPaket_Helper_Model_Table_MeinPaket_PrepareData extends ML_Form_Helper_Model_Table_PrepareData_Abstract{
    ...
    protected function primaryCategoryField (&$aField) {
        ...
        if (!isset($aField['value'])) {
            $this->aErrors[] = 'meinpaket_prepare_form_category';
