...
MLI18n::gi()->meinpaket_config_account_title = 'Zugangsdaten';
MLI18n::gi()->meinpaket_config_account_prepare = 'Artikelvorbereitung';
MLI18n::gi()->meinpaket_config_account_price = 'Preisberechnung';
MLI18n::gi()->meinpaket_config_account_sync = 'Synchronisation';
MLI18n::gi()->meinpaket_config_account_orderimport = 'Bestellimport';
MLI18n::gi()->meinpaket_config_account_emailtemplate = 'Promotion-E-Mail Template';
MLI18n::gi()->meinpaket_config_account_emailtemplate_sender = 'Beispiel-Shop';
MLI18n::gi()->meinpaket_config_account_emailtemplate_sender_email = 'beispiel@onlineshop.de';
MLI18n::gi()->meinpaket_config_account_emailtemplate_subject = 'Ihre Bestellung bei #SHOPURL#';
MLI18n::gi()->meinpaket_config_account_emailtemplate_content = '
    <style>
...
MLI18n::gi()->meinpaket_preimport_start_help = 'Startzeitpunkt, ab dem die Bestellungen erstmalig '
        ...
        . 'da die Daten bei MeinPaket höchstens einige Wochen lang vorliegen.';

MLI18n::gi()->add('meinpaket_config_account', array(
    'legend' => array(
...
MLI18n::gi()->add('meinpaket_config_prepare', array(
    'legend' => array(
    ...
    'field' => array(
        ...
        'catmatch.mpshopcats' => array(
            ...
            'valuehint' => 'Kategorien dieses Shops als eigene MeinPaket-Kategorien verwenden'
        ),
        'shippingcost' => array (
            'label' => 'Versandkosten',
        ...
        'checkin.skipean' => array(
            ...
            'help' => 'Wenn die Checkbox aktiviert ist, wird eine am Artikel hinterlegte EAN zu MeinPaket '
                . '&uuml;bertragen.<br><br> Bitte beachten Sie, dass MeinPaket dann versucht die EAN an '
                . 'bestehende Artikel zu matchen. Dies kann dazu f&uuml;hren, dass bei abweichenden Informationen der '
                . 'Artikel von MeinPaket zur&uuml;ckgewiesen wird. Die EAN ist KEIN Pflichtfeld bei MeinPaket.',
        ),
        ...
        'checkin.taxmatching' => array(
            ...
            'help' => 'Shop-eigene Steuerklassen denen von MeinPaket zuordnen.',
            'matching' => array(
                'titlesrc' => '',
                'titledst' => '',
                'labelsdst' => array(
        ...
        'checkin.shortdesc' => array(
            ...
            'help' => 'Die Kurzbeschreibung ist ein Pflichfeld bei MeinPaket. Standardm&auml;&szlig;ig wird hier '
        ...
        'checkin.longdesc' => array(
            ...
            'help' => 'Die Langbeschreibung ist kein Pflichfeld bei MeinPaket. Standardm&auml;&szlig;ig wird diese '
                . "nicht &uuml;bertragen.Sie k&ouml;nnen jedoch auch die Langbeschreibung aus einem anderen "
                . 'Datenfeld verwenden, und diese an MeinPaket &uuml;bertragen.<br>',
        ),
        'imagesize' => array(
...
MLI18n::gi()->add('meinpaket_config_price', array(
    'legend' => array(
    ...
    'field' => array(
        ...
        'price.signal' => array(
            ...
            'help' => '
                Dieses Textfeld wird beim &Uuml;bermitteln der Daten zu MeinPaket als Nachkommastelle an Ihrem Preis &uuml;bernommen.<br><br>
...
MLI18n::gi()->add('meinpaket_config_orderimport', array(
    'legend' => array(
        'importactive' => 'Bestellimport',
        'mwst' => 'Mehrwertsteuer',
        'orderstatus' => 'Synchronisation des Bestell-Status vom Shop zu MeinPaket',
    ),
    'field' => array(
        'importactive' => array(
        ...
        'preimport.start' => array(
            ...
            'help' => 'Startzeitpunkt, ab dem die Bestellungen erstmalig importiert werden sollen. Bitte beachten Sie, 
                dass dies nicht beliebig weit in die Vergangenheit möglich ist, da die Daten bei MeinPaket höchstens 
        ...
        'orderstatus.open' => array(
            ...
            'help' => '
                Der Status, den eine von MeinPaket neu eingegangene Bestellung im Shop automatisch bekommen soll.<br>
        ...
        'orderimport.shippingmethod' => array(
            ...
            'help' => 'Versandart, die allen MeinPaket-Bestellungen zugeordnet wird. Standard: "marketplace".<br><br>'
        ...
        'orderimport.paymentmethod' => array(
            ...
            'help' => 'Zahlart, die allen MeinPaket-Bestellungen zugeordnet wird. Standard: "marketplace".<br><br>'
                . 'Diese Einstellung ist wichtig f&uuml;r den Rechnungs- und Lieferscheindruck und f&uuml;r '
                . 'die nachtr&amul;gliche Bearbeitung der Bestellung im Shop sowie einige Warenwirtschaften.',
        ),
        'mwst.fallback' => array(
        ...
        'mwst.shipping' => array(
            ...
            'help' => 'MeinPaket &uuml;bermittelt nicht den Steuersatz der Versandkosten, sondern nur die 
            ...
            'help' => '
                <dl>
                    ...
                    <dd>
                        ...
                        den aktuellen Versendet-Status zu MeinPaket.<br>
        ...
        'orderstatus.shipped' => array(
            ...
            'help' => 'Setzen Sie hier den Shop-Status, der auf MeinPaket automatisch den Status "Versand best&auml;tigen" setzen soll.',
        ),
        'orderstatus.canceled.customerrequest' => array(
            ...
            'help' => 'Meinpaket verlangt die &Uuml;bermittlung eines Grundes bei einer Stornierung.<br><br>
                Setzen Sie hier den Shop-Status, der auf Meinpaket.de dem Status "Stornieren auf Kundenwunsch (Customer Request)" 
                setzen soll.<br><br>
        ...
        'orderstatus.canceled.outofstock' => array(
            ...
            'help' => 'Meinpaket verlangt die &Uuml;bermittlung eines Grundes bei einer Stornierung.<br><br>
                Setzen Sie hier den Shop-Status, der auf Meinpaket.de automatisch den Status "Stornieren, da Ware 
        ...
        'orderstatus.canceled.dealerrequest' => array(
            ...
            'help' => 'Meinpaket verlangt die &Uuml;bermittlung eines Grundes bei einer Stornierung.<br><br>
                Setzen Sie hier den Shop-Status, der auf Meinpaket.de automatisch den Status "Storniert durch 
...
MLI18n::gi()->add('meinpaket_config_sync', array(
    'legend' => array(
    ...
    'field' => array(
        'stocksync.tomarketplace' => array(
            ...
            'help' => '
                <dl>
                    ...
                    <dd>Die Funktion "Automatische Synchronisierung" gleicht alle 4 Stunden (beginnt um 0:00 Uhr nachts)
                        den aktuellen MeinPaket-Lagerbestand an der Shop-Lagerbestand an 
            ...
            'values' => array(
                ...
                */'abs' => 'Bestellung / Artikel bearbeiten setzt MeinPaket-Lagerbestand gleich Shop-Lagerbestand',
                'rel' => 'Bestellung / Artikel bearbeiten &auml;ndert MeinPaket-Lagerbestand (Differenz)',
                'no' => '{#i18n:configform_sync_value_no#}',
            ),
        ),
        'stocksync.frommarketplace' => array(
            'label' => 'Lagerver&auml;nderung MeinPaket',
            'help' => '
                Wenn z. B. bei MeinPaket ein Artikel 3 mal gekauft wurde, wird der Lagerbestand im Shop um 3 reduziert.<br><br>
        ...
        'inventorysync.price' => array(
            ...
            'help' => '
                <p>
                    ...
                    den aktuellen Shop-Preis auf Ihren MeinPaket-Preis an.<br>
            ...
            'values' => array(
                'auto' => '{#i18n:configform_sync_value_auto#}',
                'edit' => 'Artikel bearbeiten im Shop &auml;ndert Preis auf MeinPaket',
                'no' => '{#i18n:configform_sync_value_no#}',
            ),
        ),
    ),
...
MLI18n::gi()->add('meinpaket_config_emailtemplate', array(
    'legend' => array(
