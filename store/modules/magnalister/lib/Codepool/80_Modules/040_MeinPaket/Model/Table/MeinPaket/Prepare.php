...
class ML_MeinPaket_Model_Table_MeinPaket_Prepare extends ML_Database_Model_Table_Prepare_Abstract {

    protected $sTableName = 'magnalister_meinpaket_prepare';
    ...
    public function getTopPrimaryCategories() {
        return $this->getTopCategories('meinpaket_categoriesmarketplace', 'PrimaryCategory');
    }
