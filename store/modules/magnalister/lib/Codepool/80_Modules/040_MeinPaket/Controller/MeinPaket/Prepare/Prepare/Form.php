...
class ML_MeinPaket_Controller_MeinPaket_Prepare_Prepare_Form extends ML_Form_Controller_Widget_Form_PrepareAbstract {
    ...
    protected function variationConfigurationField(&$aField) {
        $aList = MLDatabase::factory('meinpaket_variantmatching')->getAllItems();
