...
MLI18n::gi()->{'ebay_config_account_title'} = 'Mes coordonnées';
...
MLI18n::gi()->{'ebay_config_account_emailtemplate'} = 'Gabarit de courriel';
MLI18n::gi()->{'ebay_config_account_producttemplate'} = 'Gabarit pour fiche de produit';
MLI18n::gi()->{'ebay_configform_prepare_hitcounter_values__NoHitCounter'} = 'Aucun';
MLI18n::gi()->{'ebay_configform_prepare_hitcounter_values__BasicStyle'} = 'simple';
MLI18n::gi()->{'ebay_configform_prepare_hitcounter_values__RetroStyle'} = 'Style rétro';
MLI18n::gi()->{'ebay_configform_prepare_hitcounter_values__HiddenStyle'} = 'caché';
...
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__8'} = '8 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__9'} = '9 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__10'} = '10 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__11'} = '11 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__12'} = '12 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__13'} = '13 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__14'} = '14 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__15'} = '15 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__16'} = '16 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__17'} = '17 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__18'} = '18 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__19'} = '19 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__20'} = '20 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__21'} = '21 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__22'} = '22 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__23'} = '23 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__24'} = '24 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__25'} = '25 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__26'} = '26 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__27'} = '27 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__28'} = '28 jours';
MLI18n::gi()->{'ebay_configform_prepare_dispatchtimemax_values__29'} = '29 jours';
...
MLI18n::gi()->{'ebay_configform_stocksync_values__rel'} = 'Une commande réduit le stock en magasin (recommandée)';
...
MLI18n::gi()->{'ebay_configform_sync_chinese_values__abs'} = 'Traiter une commande / un article, c\'est comparer le stock sur eBay et le stock de la boutique en ligne';
MLI18n::gi()->{'ebay_configform_sync_chinese_values__rel'} = 'Traiter une commande / un article, c\'est changer le stock sur eBay (différence)';
MLI18n::gi()->{'ebay_configform_sync_chinese_values__onlydecr'} = 'Traiter une commande, c\'est réduire le stock sur eBay (pas d\'augmentation)';
...
MLI18n::gi()->{'ebay_config_sync_inventory_import__true'} = 'Oui';
MLI18n::gi()->{'ebay_config_sync_inventory_import__false'} = 'Non';
...
';
MLI18n::gi()->{'ebay_config_account__legend__account'} = 'Mes coordonnées';
...
MLI18n::gi()->{'ebay_config_account__field__username__label'} = 'Pseudo';
MLI18n::gi()->{'ebay_config_account__field__username__help'} = 'Donnez ici votre pseudo eBay.';
MLI18n::gi()->{'ebay_config_account__field__username__hint'} = '';
MLI18n::gi()->{'ebay_config_account__field__password__label'} = 'Mot de passe';
MLI18n::gi()->{'ebay_config_account__field__password__help'} = 'Donnez ici votre mot de passe eBay';
MLI18n::gi()->{'ebay_config_account__field__token__label'} = 'Jeton (Token)';
MLI18n::gi()->{'ebay_config_account__field__token__help'} = 'Le jeton (Token) est obligatoire, pour pouvoir utiliser magnalister, pour traiter et gérer vos articles sur eBay. Il est renouvelable tous les deux ans.<br>
...
MLI18n::gi()->{'ebay_config_prepare__field__mwst__help'} = 'Montant de la TVA, qui sera affiché sur eBay. A ne remplir seulement, que si vous avez un compte marchand commercial sur eBay.';
MLI18n::gi()->{'ebay_config_prepare__field__mwst__hint'} = '&nbsp;Taux d\'imposition pour les marchands en %';
...
MLI18n::gi()->{'ebay_config_prepare__field__topten__label'} = 'ebay_config_prepare__field__topten__label';
MLI18n::gi()->{'ebay_config_prepare__field__topten__help'} = 'ebay_config_prepare__field__topten__help';
...
Plus d’information : http://pages.ebay.fr/help/sell/contextual/inframe/gallery.html et http://pages.ebay.fr/help/sell/pictures.html#free';
MLI18n::gi()->{'ebay_config_prepare__field__gallerytype__hint'} = 'L\'option "Galerie plus" est payante';
MLI18n::gi()->{'ebay_config_prepare__field__gallerytype__alert__Plus__title'} = 'ebay_config_prepare__field__gallerytype__alert__Plus__title';
MLI18n::gi()->{'ebay_config_prepare__field__gallerytype__alert__Plus__content'} = 'ebay_config_prepare__field__gallerytype__alert__Plus__content';
...
MLI18n::gi()->{'ebay_config_prepare__field__paymentmethods__help'} = 'Préréglages de la méthode de paiement (sélection multiple possible avec la touche Strg enfoncée et le clic de la souris). <br>
Catégories de sélection données selon les possibilités de payements autorisés sur eBay.';
...
MLI18n::gi()->{'ebay_config_prepare__field__shippinglocalcontainer__help'} = 'Sélectionnez au moins un ou plusieurs modes de livraison, qui seront utilisés de façon automatique.<br> <br>
...
Vous pouvez créer des profils clients en vous rendant sur “ Mon eBay” &rarr; “compte du membre” &rarr; “paramètres” &rarr; “conditions de livraison”.<br><br>
...
MLI18n::gi()->{'ebay_config_prepare__field__shippinginternationalprofile__notavailible'} = 'Seulement si `<i>Livraison pour l\'étranger</i>` est actif.';
...
MLI18n::gi()->{'ebay_config_prepare__field__usevariations__help'} = 'Si la fonction est activée, les déclinaisons de vos produits (taille, couleur) seront automatiquement transmises à eBay. <br>
...
Si vous avez activé l’action “Prendre en charge le stock de la boutique moins la valeur du champ de droite”,  qui se trouve sous l’onglet “Calcul des prix”, rubrique “Paramètres des listings de prix fixes” &rarr; “quantité” et que dans le champ de droite est inscrit par exemple 2 (quantité d’articles que vous réservez à une autre place de marché).<br>
 L’article apparaîtra sur eBay, 6 fois en bleue, 3 fois en vert et la version en noir n\'apparaîtra pas. <br>
<br>
...
MLI18n::gi()->{'ebay_config_prepare__field__useprefilledinfo__label'} = 'ebay_config_prepare__field__useprefilledinfo__label';
MLI18n::gi()->{'ebay_config_prepare__field__useprefilledinfo__help'} = 'ebay_config_prepare__field__useprefilledinfo__help';
MLI18n::gi()->{'ebay_config_prepare__field__useprefilledinfo__valuehint'} = 'ebay_config_prepare__field__useprefilledinfo__valuehint';
MLI18n::gi()->{'ebay_config_prepare__field__privatelisting__label'} = 'Listing privé (liste)';
MLI18n::gi()->{'ebay_config_prepare__field__privatelisting__help'} = 'Si la fonction est activée, la liste des enchérisseurs et des acheteurs n’est pas publique.';
...
MLI18n::gi()->{'ebay_config_prepare__field__hitcounter__label'} = 'Compteur de visiteurs';
MLI18n::gi()->{'ebay_config_prepare__field__hitcounter__help'} = 'Paramètres du compteur de visiteurs pour les listings.';
...
MLI18n::gi()->{'ebay_config_prepare__field__imagesize__hint'} = 'Enregistrée à: {#setting:sImagePath#}';
...
<br>
plus d’informations (en Allemand uniquement disponible) sous : <br>http://pages.ebay.de/help/sell/gallery-upgrade.html<br>
<br>
...
<br>
<b>Attention : </b>L’option “Pack d’images” n’est pas disponible pour les pays francophones. Si vous vendez sur d’autres marchés nationaux, consulter les pages d’informations des différentes places de marché eBay pour savoir si l’option est disponible.';
...
MLI18n::gi()->{'ebay_config_price__field__fixed.quantity__label'} = 'Quantité';
MLI18n::gi()->{'ebay_config_price__field__fixed.quantity__help'} = 'Cette rubrique vous permet d’indiquer les quantités disponibles d’un article de votre stock, pour une place de marché particulière.<br> <br>
...
Cette option ouvre automatiquement un champ sur la droite, qui vous permet de donner des quantités à exclure de la comptabilisation de votre inventaire général, pour les réserver à un marché particulier. <br><br>

<strong>Exemple :</strong> Stock en boutique : 10 (articles) → valeur entrée: 2 (articles) &rarr; Stock alloué à eBay: 8 (articles).<br><br>

<strong>Remarque :</strong> Si vous souhaitez cesser la vente sur eBay, d’un article que vous avez encore en stock, mais que vous avez désactivé de votre boutique, procédez comme suit: <ol type="1">
...
<strong>Autre méthode :</strong> Si vous téléchargez vos articles directement à partir de l’onglet “Téléchargement”, il vous est aussi possible d’attribuer une quantité de stock impartie à l’article en question. Dans ce cas, il est recommandé de désactiver la synchronisation automatique. 
Pour cela : <br>
<ol type="1">
<li>Cliquez sur l’onglet “Synchronisation des inventaires”;</li>
<li>Rendez-vous à la rubrique "Changement dans le stock en boutique".</li>';
MLI18n::gi()->{'ebay_config_price__field__maxquantity__label'} = 'Quantité limitée';
MLI18n::gi()->{'ebay_config_price__field__maxquantity__help'} = 'Cette fonction vous permet de limiter la quantité disponible d’un article, sur votre marché  eBay.<br><br>

<strong>Exemple :</strong> Sous la rubrique "Quantité", choisissez l’option "Prendre en charge (cas) le stock de la boutique" puis inscrivez “20” sous la rubrique “Quantité limitée”.  
Ainsi ne seront vendables sur eBay, que 20 pièces d’un article donné, disponible dans le stock de votre  boutique. <br>
La synchronisation du stock (si elle est activée) harmonisera dans ce cas  les quantités entre vos différents stocks à concurrence de 20 pièces maximum. <br><br>
...
MLI18n::gi()->{'ebay_config_price__field__fixed.price__label'} = 'Prix';
...
MLI18n::gi()->{'ebay_config_price__field__fixed.price.signal__label'} = 'Séparateur décimal';
MLI18n::gi()->{'ebay_config_price__field__fixed.price.signal__hint'} = 'Séparateur décimal';
...
MLI18n::gi()->{'ebay_config_price__field__fixed.priceoptions__label'} = 'Options de prix';
...
MLI18n::gi()->{'ebay_config_price__field__chinese.quantity__label'} = 'Quantité';
...
MLI18n::gi()->{'ebay_config_price__field__chinese.price.signal__label'} = 'Séparateur décimal';
MLI18n::gi()->{'ebay_config_price__field__chinese.price.signal__hint'} = 'Séparateur décimal';
...
MLI18n::gi()->{'ebay_config_price__field__chinese.buyitnow.price.signal__label'} = 'Séparateur décimal';
MLI18n::gi()->{'ebay_config_price__field__chinese.buyitnow.price.signal__hint'} = 'Séparateur décimal';
...
MLI18n::gi()->{'ebay_config_price__field__fixed.duration__label'} = 'Durée de la vente';
MLI18n::gi()->{'ebay_config_price__field__fixed.duration__help'} = 'Cette fonction vous permet de régler la durée de la vente d’un article.<br><br>

Le réglage peut être aussi modifié dans la préparation de l\'article.';
MLI18n::gi()->{'ebay_config_price__field__ebayplus__label'} = 'eBay plus';
MLI18n::gi()->{'ebay_config_price__field__ebayplus__valuehint'} = 'eBay plus';
MLI18n::gi()->{'ebay_config_price__field__ebayplus__help'} = 'Vous pouvez activer eBay Plus dans votre compte eBay. Cette fonction n’est disponible que dans la version allemande d’eBay pour l’instant. <br><br>

Cette option est un préréglage pour le chargement des données via magnalister. Vous pouvez cocher la case si vous avez activé eBay Plus dans votre compte eBay. Elle n’affecte pas les préréglages configurés dans votre compte eBay ( ces réglages sont uniquement  configurable dans votre compte eBay)<br><br>
...
<ul style="list-style-type:disc">
  ...
  <li>Il arrive que des commandes ayant un mode d’expédition pas admit par eBay Plus soient comme même expédiés. Dans ce cas un avertissement apparaîtra dans l’aperçu détaillé de la commande.</li>
</ul>';
MLI18n::gi()->{'ebay_config_price__field__fixed.price.usespecialoffer__label'} = 'Utilisez également des tarifs spéciaux';
...
MLI18n::gi()->{'ebay_config_price__field__chinese.duration__label'} = 'Durée de l\'enchère';
MLI18n::gi()->{'ebay_config_price__field__chinese.duration__help'} = 'Cette fonction vous permet de régler la durée de la vente au enchère d’un article.
<br><br>
Le réglage peut être aussi modifié dans la préparation de l\'article.';
...
En activant cette fonction, le taux de change actuel défini par Yahoo-Finance sera appliqué à vos articles. Les prix dans votre boutique en ligne seront également mis à jour.
<br><br>
...
MLI18n::gi()->{'ebay_config_sync__field__syncproperties__help'} = 'Dans de nombreuses catégories, eBay demande les codes EAN* (European Article Number - Code Universel des Produits), MPN (Numéro d\'Article Fabricant) et la Marque, pour l’identifier les articles. Le classement ou ranking de vos articles, peut être affecté  par le manque ou l’oubli de la transmission de ces données. De même la synchronisation des prix et des états de stock ne sera pas prise en compte par eBay, pour les articles dont les codes manquent.  <br> <br>
...
MLI18n::gi()->{'ebay_config_sync__field__syncproperties__valuehint'} = 'Activer la synchronisation des codes';
...
MLI18n::gi()->{'ebay_config_sync__field__inventory.import__label'} = 'Synchronisez les articles ne venant pas de la boutique';
MLI18n::gi()->{'ebay_config_sync__field__inventory.import__help'} = 'Est-ce que des articles, non enregistrés sur magnalister, doivent être affichés et synchronisés?<br/><br/>Si la fonction est activée, tous les articles sur ce compte eBay, seront proposés sur eBay, et seront chargés tous les soirs dans la base de données magnalister et affichés dans les \'Listings\' du Plugin.<br/><br/>.<br/><br/>La synchronisation des prix et des inventaires fonctionne aussi pour ces articles, si le code SKU (unité de gestion des stocks) sur eBay correspond à un numéro d\'article dans la boutique en ligne.<br/><br/>En outre vous devez avoir tout réglé sur "configuration  globale" > "Synchronisation du processus de numérotation" > "Numéro d\'article (en boutique) = SKU (Place de marché)".<br/>Veuillez noter, s\'il vous plaît, que si vous modifiez le processus de numérotation, tout doit être également renouvelé sur les places de marché, afin d\'assurer une synchronisation correcte et stable.<br/>Demandez conseil ici, si nécessaire.<br/><br/>Cette fonctionnalité n\'est pas actuellement disponible pour les articles avec variantes, extérieurs au magasin.';
MLI18n::gi()->{'ebay_config_sync__field__chinese.stocksync.tomarketplace__label'} = 'Variation du stock boutique';
MLI18n::gi()->{'ebay_config_sync__field__chinese.stocksync.tomarketplace__help'} = '<b>Synchronisation automatique via CronJob (recommandée)</b><br>
Utilisez la fonction “synchronisation automatique” pour que votre stock eBay soit mis à jour par rapport à votre stock en boutique. Cette mise à jour aura lieu toutes les quatre heures à moins que vous ayez définit d’autres paramètres de configuration. Les données de votre base de données seront  appliquées sur eBay même si les changements ont uniquement eut lieu dans votre bases de donnée.<br>
...
<br>
Toute importation provenant d’un client n’utilisant pas le tarif flat ou ne respectant pas le délai de 15 minute sera bloqué.<br>
<br>
<b>Commande ou modification d’un article; répercutions du stock boutique sur le stock eBay</b><br>
...
MLI18n::gi()->{'ebay_config_orderimport__field__orderstatus.sync__label'} = 'Synchronisation du statut';
MLI18n::gi()->{'ebay_config_orderimport__field__orderstatus.sync__hint'} = '';
MLI18n::gi()->{'ebay_config_orderimport__field__orderstatus.sync__help'} = '<strong>Synchronisation automatique via CronJob (recommandée).</strong>
<p>La fonction synchronisation automatique via CronJob transmet toutes les heures et à partir de minuit, le statut actuel des commandes effectué sur eBay.
...
<br>
A partir du "tarif Flat", l’actualisation d’importation via CronJob se fait au maximum toutes les 15 minutes, en déclenchant les importations et en cliquant sur le lien suivant vers votre boutique: 
<br>
{#setting:sSyncInventoryUrl#}</p>
...
';
MLI18n::gi()->{'ebay_config_orderimport__field__importonlypaid__alert'} = 'ebay_config_orderimport__field__importonlypaid__alert';
...
<p>
Si vous sélectionnez „Attribution automatique", magnalister reprend le mode de paiement, choisi par l\'acheteur sur ebay.
Le processus sera alors également fixé une autre fois sous Shopware > Paramètres > Modes de paiement.</p>
<p>
Vous pouvez également définir toutes les autres méthodes de paiement disponibles dans la liste, sous Shopware > Paramètres > Modes de paiement et les utiliser ici.</p>
<p>
...
MLI18n::gi()->{'ebay_config_orderimport__field__mwstfallback__label'} = 'TVA pour les articles extérieurs à la boutique';
MLI18n::gi()->{'ebay_config_orderimport__field__mwstfallback__hint'} = 'Le taux d\'imposition lors d\'une importation de commandes d\'articles ne venant pas de la boutique sera alors calculé en %.';
...
MLI18n::gi()->{'ebay_config_orderimport__field__updateableorderstatus__label'} = 'Autorisez le changement de statut si';
MLI18n::gi()->{'ebay_config_orderimport__field__updateableorderstatus__help'} = 'Vous pouvez avec cette commande synchroniser le changement de statut des commandes après paiements sur eBay. <br>
...
MLI18n::gi()->{'ebay_config_orderimport__field__preimport.start__help'} = 'Point de départ, dès que la première importation de commandes est effectuée. Veuillez noter que celle-ci ne peut être éloignée dans le temps, car les données sur eBay ne peuvent pas dépasser plus de quelques semaines au maximum.';
...
MLI18n::gi()->{'ebay_config_orderimport__field__customergroup__help'} = 'Groupes dans lesquels vos clients sont ordonnés lors d’une nouvelle commande.';
...
MLI18n::gi()->{'ebay_config_orderimport__field__orderstatus.open__help'} = 'La fonction “Statut de la commande” permet qu’une commande passée sur eBay soit automatiquement envoyée à la boutique en ligne.<br>
...
MLI18n::gi()->{'ebay_config_orderimport__field__orderstatus.paid__label'} = 'Statut "payé" d\'eBay, en magasin  ';
MLI18n::gi()->{'ebay_config_orderimport__field__orderstatus.paid__help'} = 'Le statut, que la commande obtient en magasin, si elle est payée sur eBay.';
...
MLI18n::gi()->{'ebay_config_emailtemplate__legend__mail'} = 'Gabarit de courriel';
MLI18n::gi()->{'ebay_config_emailtemplate__field__mail.send__label'} = 'Envoyer';
MLI18n::gi()->{'ebay_config_emailtemplate__field__mail.send__help'} = 'Activez cette fonction si vous voulez qu’un courriel soit envoyé à vos clients, afin de promouvoir votre boutique en ligne.';
