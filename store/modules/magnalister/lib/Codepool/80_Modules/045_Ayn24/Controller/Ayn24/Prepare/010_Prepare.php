...
class ML_Ayn24_Controller_Ayn24_Prepare_Prepare extends ML_Productlist_Controller_Widget_ProductList_Selection {

    protected $aParameters = array('controller');

    public static function getTabTitle() {
        return MLI18n::gi()->get('ayn24_prepare_prepare');
    }
    ...
    public function __construct() {
        ...
        try {
            ...
            if (in_array($sExecute, array('unprepare'))) {
                $oModel = MLDatabase::factory('ayn24_prepare');
