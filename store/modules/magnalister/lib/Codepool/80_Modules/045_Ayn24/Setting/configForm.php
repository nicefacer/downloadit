...
MLSetting::gi()->add('ayn24_config_account', array(
    'tabident' => array(
        'legend' => array(
...
MLSetting::gi()->add('ayn24_config_prepare', array(
    'prepare' => array(
        'fields' => array(
            array(
                'name' => 'prepare.status',
...
MLSetting::gi()->add('ayn24_config_price', array(
    'price' => array(
        'fields' => array(
            array(
                'name' => 'price',
...
MLSetting::gi()->add('ayn24_config_orderimport', array(
    'importactive' => array(
        'fields' => array(
            'importactive' => array(
                'name' => 'importactive',
            ...
            /*array(
                ...
                'subfields' => array(
                    ...
                    'string' => array('name' => 'orderimport.shippingmethod.name', 'default' => 'dhlayn24'),
                ),
            ),
            array(
                'name' => 'defaultpayment',
                ...
                'subfields' => array(
                    ...
                    'string' => array('name' => 'orderimport.paymentmethod.name', 'default' => 'ayn24'),
                ),
            ),*/
        ),
    ),
...
MLSetting::gi()->add('ayn24_config_sync', array(
    'sync' => array(
        'fields' => array(
            array(
...
MLSetting::gi()->add('ayn24_config_emailtemplate', array(
    'mail' => array(
        'fields' => array(
            array(
                'name' => 'mail.send',
            ...
            array(
                ...
                'type' => 'string',
                'default' => '{#i18n:ayn24_config_account_emailtemplate_sender#}',
            ),
            array(
                'name' => 'mail.originator.adress',
                'type' => 'string',
                'default' => '{#i18n:ayn24_config_account_emailtemplate_sender_email#}',
            ),
            array(
                'name' => 'mail.subject',
                'type' => 'string',
                'default' => '{#i18n:ayn24_config_account_emailtemplate_subject#}',
            ),
            array(
                'name' => 'mail.content',
                'type' => 'configMailContentContainer',
                'default' => '{#i18n:ayn24_config_account_emailtemplate_content#}',
            ),
            array(
                'name' => 'mail.copy',
                'type' => 'radio',
