                            ...
                            <tr>
                                <td class="textleft">
                                    <form  class="right" action="<?php echo $this->getCurrentUrl() ?>" method="post" title="<?php echo ML_STATUS_FILTER_SYNC_ITEM ?>">
                                        ...
                                        <input type="submit" value="<?php echo $this->__('ML_BUTTON_LABEL_CHECKIN_ADD') ?>" class="js-marketplace-upload mlbtn action" />
                                    </form>
                                </td>
                            </tr>
                            <tr>
                                <td class="textleft">
                                    <form  class="right" action="<?php echo $this->getCurrentUrl() ?>" method="post" title="<?php echo ML_STATUS_FILTER_SYNC_ITEM ?>">
                                        ...
                                        <input type="submit" value="<?php echo $this->__('ML_BUTTON_LABEL_CHECKIN_PURGE') ?>" class="js-marketplace-upload mlbtn" />
                                    </form>
                                </td>
                            </tr>
                        </table>
