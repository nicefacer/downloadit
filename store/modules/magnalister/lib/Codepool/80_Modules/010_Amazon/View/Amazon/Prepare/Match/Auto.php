...
<h1><?php echo MLI18n::gi()->get('Amazon_Productlist_Match_Auto_Title')?></h1>
<form id="js-amazon-auto" action="<?php echo $this->getCurrentUrl() ?>" method="post" title="<?php echo $this->__('ML_AMAZON_LABEL_AUTOMATIC_MATCHING'); ?>">
...
<script type="text/javascript">/*<![CDATA[*/
    (function($) {
        $('#js-amazon-auto').submit(function(){
