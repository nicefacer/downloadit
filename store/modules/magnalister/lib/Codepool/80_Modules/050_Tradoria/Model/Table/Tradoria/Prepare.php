...
class ML_Tradoria_Model_Table_Tradoria_Prepare extends ML_Database_Model_Table_Prepare_Abstract {

    protected $sTableName = 'magnalister_tradoria_prepare';
    ...
    public function set($sName, $mValue) {
        ...
        if (
            $mValue !== NULL && in_array($sName, array('primarycategory', 'secondarycategory', 'storecategory'))
        ) {
    ...
    public function getTopPrimaryCategories() {
        return $this->getTopMarketplaceCategories('tradoria_categoriesmarketplace', 'topprimarycategory');
    }

    public function getTopSecondaryCategories() {
        return $this->getTopMarketplaceCategories('tradoria_categoriesmarketplace', 'topsecondarycategory');
    }

    public function getTopStoreCategories() {
        return $this->getTopCategories('tradoria_categoriesstore', 'topstorecategory', "mpid = '" . MLModul::gi()->getMarketPlaceId() . "'");
    }
    ...
    protected function getTopMarketplaceCategories($sClass, $sField) {
        return $this->getTopCategories($sClass, $sField);
    }
