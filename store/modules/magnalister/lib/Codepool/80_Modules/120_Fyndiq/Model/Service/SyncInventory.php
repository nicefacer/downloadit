...
class ML_Fyndiq_Model_Service_SyncInventory extends ML_Modul_Model_Service_SyncInventory_Abstract
{
            ...
            try {
                do {
                    ...
                    foreach ($aResponse['DATA'] as $iItem => $aItem) {
                        ...
                        try {
                            $oProduct = MLProduct::factory()->getByMarketplaceSKU($aItem['ArticleSKU']);
                            if ($oProduct->exists()) {
                                $this->log(
                                ...
                                if (isset($aUpdateRequest[$iItem])) {
                                    ...
                                    $aUpdateRequest[$iItem]['SKU'] = $aItem['ArticleSKU'];
                                }
                            } else {
