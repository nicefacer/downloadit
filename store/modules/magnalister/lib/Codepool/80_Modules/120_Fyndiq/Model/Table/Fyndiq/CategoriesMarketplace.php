...
class ML_Fyndiq_Model_Table_Fyndiq_CategoriesMarketplace extends ML_Modul_Model_Table_Categories_Abstract {

    protected $sTableName = 'magnalister_fyndiq_categories_marketplace';
    ...
    public function init($blForce = false) {
        ...
        if (!isset($this->aFields['Selectable'])) {
            $this->aFields['Selectable'] = array(
                'Type' => 'tinyint(1)', 'Null' => 'NO', 'Default' => 1, 'Extra' => '', 'Comment' => ''
            );
        }
