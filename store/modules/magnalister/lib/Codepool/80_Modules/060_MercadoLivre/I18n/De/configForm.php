...
MLI18n::gi()->mercadolivre_config_account_title = 'Zugangsdaten';
MLI18n::gi()->mercadolivre_config_account_prepare = 'Artikelvorbereitung';
MLI18n::gi()->mercadolivre_config_account_price = 'Preisberechnung';
MLI18n::gi()->mercadolivre_config_account_sync = 'Inventarsynchronisation';
MLI18n::gi()->mercadolivre_config_account_orderimport = 'Bestellungen';
MLI18n::gi()->mercadolivre_config_checkin_badshippingcost = 'Shipping cost must be a number.';
MLI18n::gi()->mercadolivre_config_account_emailtemplate = 'Promotion-E-Mail Template';
MLI18n::gi()->mercadolivre_config_account_emailtemplate_sender = 'Beispiel-Shop';
MLI18n::gi()->mercadolivre_config_account_emailtemplate_sender_email = 'beispiel@onlineshop.de';
MLI18n::gi()->mercadolivre_config_account_emailtemplate_subject = 'Ihre Bestellung bei #SHOPURL#';
MLI18n::gi()->mercadolivre_config_account_emailtemplate_content = '
    <style>
...
MLI18n::gi()->add('mercadolivre_config_account', array(
    'legend' => array(
    ...
    'field' => array(
        ...
        'gettoken' => array(
            ...
            'help' => 'To get authentication token click on Get token button, enter your data on MercadoLivre page'
                . ' and when window closes click on Save button below.',
            'buttontext' => 'Get token',
        ),
    ),
), false);

MLI18n::gi()->add('mercadolivre_config_prepare', array(
    'legend' => array(
    ...
    'field' => array(
		...
		'currency' => array(
            'label' => 'Currency',
            'help' => 'Selected currency will be chosen by default on checkin form if available.'
        ),
		'itemcondition' => array(
            'label' => 'Item condition',
            'help' => 'Selected item condition will be chosen by default on checkin form if available.',
			'values' => array(
				'' => '{#i18n:ML_AMAZON_LABEL_APPLY_PLEASE_SELECT#}',
				'new' => 'New',
		...
		'listingtype' => array(
            'label' => 'Listing type',
            'help' => 'Selected listing type will be chosen by default on checkin form if available.'
        ),
		'buyingmode' => array(
            'label' => 'Buying mode',
            'help' => 'Selected buying mode will be chosen by default on checkin form if available.',
			'values' => array(
				'' => '{#i18n:ML_AMAZON_LABEL_APPLY_PLEASE_SELECT#}',
		...
		'shippingmodecontainer' => array(
            'label' => 'Shipping mode',
            'help' => 'Selected shipping mode will be chosen by default on checkin form if available.',
        ),
		'shippingmode' => array(
            'label' => '',
			'values' => array(
...
MLI18n::gi()->add('mercadolivre_config_price', array(
    'legend' => array(
    ...
    'field' => array(
        ...
        'price.signal' => array(
            ...
            'help' => '
                Dieses Textfeld wird beim &Uuml;bermitteln der Daten zu MercadoLivre als Nachkommastelle an 
...
MLI18n::gi()->add('mercadolivre_config_sync', array(
    'legend' => array(
    ...
    'field' => array(
        'stocksync.tomarketplace' => array(
            ...
            'help' => '
                <p>
                    ...
                    den aktuellen MercadoLivre-Lagerbestand an der Shop-Lagerbestand an (je nach Konfiguration ggf. mit Abzug).<br>
        ...
        'stocksync.frommarketplace' => array(
            'label' => 'Lagerveränderung MercadoLivre',
            'help' => '
                Wenn z. B. bei MercadoLivre ein Artikel 3 mal gekauft wurde, wird der Lagerbestand im Shop um 3 reduziert.<br><br>
        ...
        'inventorysync.price' => array(
            ...
            'help' => '
                <p>
                    Die Funktion "Automatische Synchronisierung" gleicht alle 4 Stunden (beginnt um 0:00 Uhr nachts)
                    den aktuellen Shop-Preis auf Ihren MercadoLivre-Preis an.<br>
                    Dabei werden die Werte aus der Datenbank gepr&uuml;ft und &uuml;bernommen, auch wenn die &Auml;nderungen durch z.B. 
...
MLI18n::gi()->add('mercadolivre_config_orderimport', array(
    'legend' => array(
        'importactive' => 'Bestellimport',
        'mwst' => 'Mehrwertsteuer',
        'orderstatus' => 'Synchronisation des Bestell-Status vom Shop zu MercadoLivre',
    ),
    'field' => array(
        'orderstatus.sync' => array(
            ...
            'help' => '
                <dl>
                    ...
                    <dd>
                        Die Funktion "Automatische Synchronisierung per CronJob" &uuml;bermittelt alle 2 Stunden den aktuellen Versendet-Status zu MercadoLivre.<br/>
        ...
        'orderstatus.shipped' => array(
            ...
            'help' => 'Setzen Sie hier den Shop-Status, der auf MercadoLivre automatisch den Status "Versand best&auml;tigen" setzen soll.',
        ),
        'orderstatus.canceled' => array(
            'label' => 'Bestellung stornieren mit',
            'help' => '
                Setzen Sie hier den Shop-Status, der auf  MercadoLivre automatisch den Status "Bestellung stornieren" setzen soll. <br/><br/>
        ...
        'mwst.shipping' => array(
            ...
            'help' => '
                MercadoLivre &uuml;bermittelt nicht den Steuersatz der Versandkosten, sondern nur die Brutto-Preise. 
        ...
        'preimport.start' => array(
            ...
            'help' => 'Startzeitpunkt, ab dem die Bestellungen erstmalig importiert werden sollen. Bitte beachten Sie, '
                . 'dass dies nicht beliebig weit in die Vergangenheit m&ouml;glich ist, da die Daten bei MercadoLivre '
        ...
        'orderstatus.open' => array(
            ...
            'help' => '
                Der Status, den eine von MercadoLivre neu eingegangene Bestellung im Shop automatisch bekommen soll.<br>
...
MLI18n::gi()->add('mercadolivre_config_emailtemplate', array(
    'legend' => array(
