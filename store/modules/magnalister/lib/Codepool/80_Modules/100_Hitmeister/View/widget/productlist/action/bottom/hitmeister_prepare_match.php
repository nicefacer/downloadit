...
<?php if ($this instanceof ML_Productlist_Controller_Widget_ProductList_Abstract) { ?>
        ...
        <div id="manMatchInfo" class="dialog2" title="<?php echo ML_LABEL_INFORMATION.' '.ML_AMAZON_LABEL_MANUAL_MATCHING; ?>"><?php echo MLI18n::gi()->get('Hitmeister_Productlist_Match_Manual_Desc'); ?></div>
        <div id="autoMatchInfo" class="dialog2" title="<?php echo ML_LABEL_INFORMATION.' '.ML_AMAZON_LABEL_AUTOMATIC_MATCHING; ?>"><?php echo MLI18n::gi()->get('Hitmeister_Productlist_Match_Auto_Desc'); ?></div>
        <div id="confirmDiag" class="dialog2" title="<?php echo ML_LABEL_NOTE; ?>"><?php echo MLI18n::gi()->get('Hitmeister_Productlist_Match_Auto_Confirm'); ?></div>
