...
<table class="matching">
    ...
    <tbody class="headline">
        <tr>
            ...
            <th class="title"><?= MLI18n::gi()->cdiscount_label_title ?></th>
            <th class="productGroup"><?= MLI18n::gi()->cdiscount_category ?></th>
            <th class="asin"><?= MLI18n::gi()->cdiscount_label_item_id ?></th>
        </tr>
    </tbody>
    ...
    <tbody class="func">
        <tr>
            <td colspan="5">
                <div><?= MLI18n::gi()->cdiscount_search_by_title ?>: <input type="text" id="newSearch_<?= $aProduct['Id'] ?>"> <input type="button" value="OK" id="newSearchGo_<?= $aProduct['Id'] ?>"></div>
                <div><?= MLI18n::gi()->cdiscount_search_by_ean ?>: <input type="text" id="newEAN_<?= $aProduct['Id'] ?>"> <input type="button" value="OK" id="newEANGo_<?= $aProduct['Id'] ?>"></div>
            </td>
        </tr>
    </tbody>
