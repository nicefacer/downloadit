 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: Shipping.php 4304 2014-07-30 13:09:16Z derpapst $
 *
...
class Shipping {
	...
	public function getShippingCost($weight, $shippingDefault = false) {
		...
		if ($this->settings['prefferedMethod'] == '_ml_lump') {
