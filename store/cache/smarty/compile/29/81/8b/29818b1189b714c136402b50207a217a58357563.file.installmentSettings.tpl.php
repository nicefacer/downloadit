<?php /* Smarty version Smarty-3.1.19, created on 2025-02-28 21:28:10
         compiled from "/homepages/40/d657041287/htdocs/modules/paypal//views/templates/admin/installmentSettings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:144216156567c21c5a9d0819-62233013%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29818b1189b714c136402b50207a217a58357563' => 
    array (
      0 => '/homepages/40/d657041287/htdocs/modules/paypal//views/templates/admin/installmentSettings.tpl',
      1 => 1740773531,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '144216156567c21c5a9d0819-62233013',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'PAYPAL_SECRET_ID_INSTALLMENT' => 0,
    'PAYPAL_ENABLE_BNPL' => 0,
  ...
  'unifunc' => 'content_67c21c5a9f9913_08722367',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67c21c5a9f9913_08722367')) {function content_67c21c5a9f9913_08722367($_smarty_tpl) {?>
...
<?php if (isset($_smarty_tpl->tpl_vars['isoCountryDefault']->value)) {?>
    <?php if ($_smarty_tpl->tpl_vars['isoCountryDefault']->value=='fr') {?>
        <div installment-disclaimer class="pp__flex pp__flex-align-center pp__mb-5 pp__pb-4">
            <div class="pp__pr-4">
                <img style="width: 135px" src="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['moduleDir']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
            ...
            <div class="configuration">
                <div class="bootstrap pp__flex" style="width: 50%">
                    <input
                            ...
                            <?php if (isset($_smarty_tpl->tpl_vars['PAYPAL_CLIENT_ID_INSTALLMENT']->value)) {?>value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['PAYPAL_CLIENT_ID_INSTALLMENT']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"<?php }?>>
                    <div>
        ...
        <div class="paypal-form-group pp__flex-align-center pp_mb-20">
            <div class="label">
                <?php if (isset($_smarty_tpl->tpl_vars['PayPal_sandbox_mode']->value)&&$_smarty_tpl->tpl_vars['PayPal_sandbox_mode']->value) {?>
                    <?php echo smartyTranslate(array('s'=>'REST Secret ID Sandbox','mod'=>'paypal'),$_smarty_tpl);?>


                <?php } else { ?>
                    <?php echo smartyTranslate(array('s'=>'REST Secret ID','mod'=>'paypal'),$_smarty_tpl);?>
            ...
            <div class="configuration">
                <div class="bootstrap pp__flex" style="width: 50%">
                    <input
                            ...
                            <?php if (isset($_smarty_tpl->tpl_vars['PAYPAL_SECRET_ID_INSTALLMENT']->value)) {?>
                                value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['PAYPAL_SECRET_ID_INSTALLMENT']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"
                            <?php }?>>
                    <div>
                        <span class="btn btn-default pp__ml-2" onclick="toggleHint(event)">?</span>
        ...
        <div class="paypal-form-group pp__flex-align-center pp_mb-20">
            <div class="label">
                <?php echo smartyTranslate(array('s'=>'Enable \'Pay Later\' in your checkout','mod'=>'paypal'),$_smarty_tpl);?>
            ...
            <div class="configuration">
                <div class="pp__switch-field">
                    <input
                            ...
                            value="1"
                            <?php if (isset($_smarty_tpl->tpl_vars['PAYPAL_ENABLE_BNPL']->value)&&$_smarty_tpl->tpl_vars['PAYPAL_ENABLE_BNPL']->value=='1') {?>checked<?php }?>/>
        ...
        <div class="paypal-form-group pp__flex-align-center pp_mb-20">
            <div class="label">
                <?php echo smartyTranslate(array('s'=>'Pay Later','mod'=>'paypal'),$_smarty_tpl);?>
                ...
                <div class="bootstrap">
                    <div class="alert alert-info">
                        ...
                        <ul>
                            ...
                            <li>
                                <?php echo smartyTranslate(array('s'=>'Copy/paste your "Secret ID"','mod'=>'paypal'),$_smarty_tpl);?>
