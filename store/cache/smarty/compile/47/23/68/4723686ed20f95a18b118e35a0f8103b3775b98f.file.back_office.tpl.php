<?php /* Smarty version Smarty-3.1.19, created on 2025-02-28 21:28:10
         compiled from "/homepages/40/d657041287/htdocs/modules/paypal//views/templates/admin/back_office.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7152748167c21c5a961ba6-40140109%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4723686ed20f95a18b118e35a0f8103b3775b98f' => 
    array (
      0 => '/homepages/40/d657041287/htdocs/modules/paypal//views/templates/admin/back_office.tpl',
      1 => 1740773531,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7152748167c21c5a961ba6-40140109',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'isoCountryDefault' => 0,
    'isShowMessageSecretIdMissing' => 0,
  ...
  'unifunc' => 'content_67c21c5a9c9f96_64071129',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67c21c5a9c9f96_64071129')) {function content_67c21c5a9c9f96_64071129($_smarty_tpl) {?>
...
<div class="bootstrap">
	...
	<?php if (isset($_smarty_tpl->tpl_vars['isShowMessageSecretIdMissing']->value)&&$_smarty_tpl->tpl_vars['isShowMessageSecretIdMissing']->value) {?>
		<div class="alert alert-danger">
			<button type="button" class="close" data-dismiss="alert" data-action="close">×</button>
			<?php echo smartyTranslate(array('s'=>'You need to fill up the Secret ID to continue use the "Pay later" functionality','mod'=>'paypal'),$_smarty_tpl);?>
...
" id="paypal_submit" />
 ...
 (<a href="https://developer.paypal.com/" target="_blank"><?php echo smartyTranslate(array('s'=>'learn more','mod'=>'paypal'),$_smarty_tpl);?>
			...
			<div data-tls-check-section>
				...
				<br /><br />
				<input type="hidden" id="security_token" value="<?php echo mb_convert_encoding(htmlspecialchars($_GET['token'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" >
...
';
	var activeNavTab = '<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['activeNavTab']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
';
</script>
<?php }} ?>
